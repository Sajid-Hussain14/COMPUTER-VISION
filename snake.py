...
class Snake:
    ...
    binary = True       # The image in binary (threshold method).
    ...
    alpha = 0.6         # The weight of the uniformity energy.
    beta = 0.5          # The weight of the curvature energy.
    delta = 0.100         # The weight of the user configured energy.
    ...
    def __init__( self, image = None, closed = True ):
        ...
        self.binary = cv2.adaptiveThreshold( self.gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 99, 60 )
    ...
    def visualize( self ):
        ...
        point_color = (0, 152, 255 )     # BGR RED
        line_color = ( 128, 255, 0 )      # BGR half blue
